...
class TrainTransformer:
    def __init__(self, args):
        ...
        # if args.checkpoint_transformer_opt_path is not None:
        #     self.optim.load_state_dict(torch.load(args.checkpoint_transformer_opt_path))
        #     print(f"Resuming training with optimizer state: {args.checkpoint_transformer_opt_path}")
    ...
    def train(self, args):
        ...
        for epoch in range(args.epochs):
            ...
            torch.save(self.optim.state_dict(), os.path.join("checkpoints", f"opt_transformer_{epoch}.pt"))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset-path', type=str, default=r"C:\Users\luvve\flowers\jpg", help='Path to data.')
    ...
    parser.add_argument('--checkpoint-transformer-opt-path', type=str, default=None, help='Path to the Transformer optimizer checkpoint to resume training from (default: None)')
    ...
    args.checkpoint_path = r"C:\Users\luvve\VQGAN\checkpoints\transformers_checkpoints\vqgan_epoch_1.pt"
    #args.checkpoint_transformer_opt_path = r"C:\Users\luvve\VQGAN\checkpoints\transformers_checkpoints\opt_vq_epoch_61.pt"
